...
public class SkeletonController : MonoBehaviour
{
	...
	public void Hurt()
	{
		...
		Object.Instantiate(deadSkeleton, base.transform.position, Quaternion.identity);
		Object.Instantiate(skeletonPs, base.transform.position, Quaternion.identity);
		shake.ShakeCam();
	}
}
